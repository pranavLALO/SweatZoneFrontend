...
@Composable
fun AdvanceWorkoutsScreen(navController: NavController) {
    ...
    val workoutCategories = listOf(
        "Chest" to Screen.AdvanceChestWorkouts.route,
        "Shoulder" to Screen.AdvanceShoulderWorkouts.route,
        "Arms" to Screen.AdvanceArmsWorkouts.route,
        "Legs" to Screen.AdvanceLegsWorkouts.route,
        "Abs" to Screen.AdvanceAbsWorkouts.route,
        "Back" to Screen.AdvanceBackWorkouts.route
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            LazyVerticalGrid(
                ...
                verticalArrangement = Arrangement.spacedBy(16.dp), // <-- Corrected this line
...
@Composable
fun AdvanceWorkoutsScreenPreview() {
    SweatzoneTheme {
        AdvanceWorkoutsScreen(navController = rememberNavController())
    }
}
