...
@Composable
fun IntermediateWorkoutsScreen(navController: NavController) {
    ...
    val workoutCategories = listOf(
        "Chest" to Screen.IntermediateChestWorkouts.route,
        "Shoulder" to Screen.IntermediateShoulderWorkouts.route,
        "Arms" to Screen.IntermediateArmsWorkouts.route,
        "Legs" to Screen.IntermediateLegsWorkouts.route,
        "Abs" to Screen.IntermediateAbsWorkouts.route,
        "Back" to Screen.IntermediateBackWorkouts.route
    )
...
@Composable
fun IntermediateWorkoutsScreenPreview() {
    SweatzoneTheme {
        IntermediateWorkoutsScreen(navController = rememberNavController())
    }
}
