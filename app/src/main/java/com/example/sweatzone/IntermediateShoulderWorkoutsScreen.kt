...
@Composable
fun IntermediateShoulderWorkoutsScreen(navController: NavController, userViewModel: UserViewModel) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        try {
            val response = com.example.sweatzone.data.api.RetrofitClient.api.getWorkoutExercises("shoulder", "intermediate")
...
fun IntermediateShoulderWorkoutsScreenPreview() {
    SweatzoneTheme {
        IntermediateShoulderWorkoutsScreen(
